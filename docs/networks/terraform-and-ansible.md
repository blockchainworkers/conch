...
script](https://github.com/blockchainworkers/conch/blob/develop/networks/remote/integration.sh)
...
```
cd $GOPATH/src/github.com/blockchainworkers/conch/networks/remote/terraform
```
...
directory](https://github.com/blockchainworkers/conch/tree/master/networks/remote/ansible)
run ansible roles to configure the sentry node architecture. You must
switch to this directory to run ansible
(`cd $GOPATH/src/github.com/blockchainworkers/conch/networks/remote/ansible`).
...
from [this
directory](https://github.com/blockchainworkers/conch/tree/master/docs/examples).
...
```
ansible-playbook -i inventory/digital_ocean.py -l sentrynet config.yml -e BINARY=$GOPATH/src/github.com/blockchainworkers/conch/build/tendermint -e CONFIGDIR=$GOPATH/src/github.com/blockchainworkers/conch/docs/examples
```
