...
For details on peer discovery, see the [peer exchange (PEX) reactor doc](https://github.com/blockchainworkers/conch/blob/master/docs/spec/reactors/pex/pex.md).
