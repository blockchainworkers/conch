...
(ABCI)](https://github.com/blockchainworkers/conch/tree/develop/abci)
...
Types](https://github.com/blockchainworkers/conch/blob/develop/abci/README.md#message-types).
