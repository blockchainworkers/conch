...
- `$GOPATH/bin` must be on your `$PATH` (see https://github.com/blockchainworkers/conch/wiki/Setting-GOPATH)
...
PR](https://github.com/blockchainworkers/conch/pull/792) for more information
