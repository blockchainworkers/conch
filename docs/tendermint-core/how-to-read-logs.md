...
- `abci-client` As mentioned in [Application Development Guide](./app-development.md), Tendermint acts as an ABCI
  ...
  be found [here](https://github.com/blockchainworkers/conch/tree/develop/abci/client).
...
- `events` Simple event notification system. The list of events can be
  found
  [here](https://github.com/blockchainworkers/conch/blob/master/types/events.go).
...
- `p2p` Provides an abstraction around peer-to-peer communication. For
  ...
  [README](https://github.com/blockchainworkers/conch/blob/master/p2p/README.md).
- `rpc` [Tendermint's RPC](./specification/rpc.md).
- `rpc-server` RPC server. For implementation details, please read the
  [README](https://github.com/blockchainworkers/conch/blob/master/rpc/lib/README.md).
