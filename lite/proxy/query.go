...
import (
	...
	"github.com/blockchainworkers/conch/lite"
	"github.com/blockchainworkers/conch/lite/client"
	certerr "github.com/blockchainworkers/conch/lite/errors"
	rpcclient "github.com/blockchainworkers/conch/rpc/client"
...
func GetWithProofOptions(path string, key []byte, opts rpcclient.ABCIQueryOptions,
	...
	*ctypes.ResultABCIQuery, KeyProof, error) {
	...
	/* // TODO refactor so iavl stuff is not in tendermint core
	   // https://github.com/blockchainworkers/conch/issues/1183
	if len(resp.Value) > 0 {
